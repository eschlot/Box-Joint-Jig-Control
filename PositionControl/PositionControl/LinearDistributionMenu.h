...
#ifndef __LINEARDISTRIBUTIONMENU_H__
#define __LINEARDISTRIBUTIONMENU_H__

#include "Menu.h"
#include "LinkedList.h"


class LinearDistributionMenu : public Menu
{
//variables
public:
protected:
private:
  ...
  float grooveWidth;
  int numberOfGrooves;
  boolean startsOnGroove;
  boolean endsOnGroove;



//functions
public:
	LinearDistributionMenu(UTFT *Disp, URTouch *Touch,TFT_Extension *TFTextention);
	virtual ~LinearDistributionMenu(void);
...
private:
	...
	LinearDistributionMenu( const LinearDistributionMenu &c );
	LinearDistributionMenu& operator=( const LinearDistributionMenu &c );
	void printErrorMessage(char const* message);
}; //LinearDistributionMenu

#endif //__LINEARDISTRIBUTIONMENU_H__
