...
enum
{
  BUTTON_GO_BACK, BUTTON_0, BUTTON_1, BUTTON_2, BUTTON_3, BUTTON_4, BUTTON_5, BUTTON_6, BUTTON_7, BUTTON_8, BUTTON_9, BUTTON_DOT, BUTTON_ENTER, BUTTON_CLEAR
};
...
#define BUTTON_DOT_COORDS BUTTON_COORDS(2,6)
...
menuButtonType floatNumberEntryMenuButton[] = {
...
SPECIALBUTTONDEF(DOT,.),
SPECIALBUTTONDEF(CLEAR,<--) };

FloatNumberEntryMenu::FloatNumberEntryMenu(UTFT *Disp, URTouch *Touch, TFT_Extension *TFTextention)
    : Menu(Disp, Touch, TFTextention)
{
  _screenButtons = floatNumberEntryMenuButton;
  _numScreenButtons = sizeof(floatNumberEntryMenuButton) / sizeof(menuButtonType);
...
FloatNumberEntryMenu::~FloatNumberEntryMenu(void)
{

}

void FloatNumberEntryMenu::setTextMessage(char const* text)
{
  this->textMessagePtr = text;
}

float FloatNumberEntryMenu::getValue()
{
  return value;
}

void FloatNumberEntryMenu::setValue(float v)
{
  this->value = v;
}

void FloatNumberEntryMenu::setReturnMenu(Menu* m)
{
  returnMenuPtr = m;
}

void FloatNumberEntryMenu::setValuePointerOnEnterPressed(float* retValPtr)
{
  valueToWriteHereOnEnterPressed = retValPtr;
}

void FloatNumberEntryMenu::menuIsActivating(void)
{
  ...
  snprintf(valueString, 40, "%.0d%.4g", (int) value / 10, value - ((int) value - (int) value % 10));
...
void FloatNumberEntryMenu::dispatch(uint8_t buttonNumber)
{
  switch (buttonNumber)
  {
    case BUTTON_GO_BACK:
  ...
  }
  {
    ...
    int numMatched = sscanf(valueString, "%f%s", &testValue, rest);
