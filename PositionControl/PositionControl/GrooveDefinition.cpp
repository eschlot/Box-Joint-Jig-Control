...
// default constructor
GrooveDefinition::GrooveDefinition()
{
  startPosition=0.0f;
  width=0.0f;
} //GrooveDefinition
...
GrooveDefinition::GrooveDefinition(float start_, float width_) : startPosition(start_), width(width_)
{
};
...
bool GrooveDefinition:: operator<(const GrooveDefinition& other)
{
